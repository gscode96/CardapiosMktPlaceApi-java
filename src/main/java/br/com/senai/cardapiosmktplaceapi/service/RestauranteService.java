...
public interface RestauranteService {
	...
	public Restaurante salvar(@NotNull(message = "O restaurante é obrigatório!") Restaurante restaurante);

	public void atualizarStatusPor(
			@NotNull(message = "O id é obrigatório!") @Positive(message = "O id deve ser positivo!") 
			Integer id,
