...
public class CardapioController {
	...
	private Map<String, Object> converter(Cardapio cardapio) {
		...
		cardapioMap.put("restaurate", restauranteMap);
	...
	public ResponseEntity<?> listarPor(@RequestParam(name = "id-restaurante") Integer idDoRestaurante,
		...
		pageMap.put("totalDePagina", page.getTotalPages());
	...
	@PutMapping
	public ResponseEntity<?> alterar(@RequestBody CardapioSalvo cardapioSalvo) {
